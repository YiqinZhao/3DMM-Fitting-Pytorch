"""A CLI for converting BFM09 data to a format that can be used by the face_fitting_pytorch library."""
...
def LoadExpBasis():  # load expression basis
    n_vertex = 53215
...
def transferBFM09():  # transfer original BFM09 to our face model
    ...
    # regions used for skin texture regularization, and 68 landmarks index etc.
