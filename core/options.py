...
class BaseOptions:
    ...
    def initialize(self):
        ...
        self.parser.add_argument(
            "--rf_lr", type=float, default=1e-2, help="learning rate for rigid fitting"
        )
        self.parser.add_argument(
            "--nrf_lr",
            type=float,
        ...
        self.parser.add_argument(
            "--lm_loss_w", type=float, default=100, help="weight for landmark loss"
        )
        self.parser.add_argument(
            "--rgb_loss_w", type=float, default=1.6, help="weight for rgb loss"
        )
        self.parser.add_argument(
            "--id_reg_w",
            type=float,
        ...
        self.parser.add_argument(
            "--rot_reg_w", type=float, default=1, help="weight for rotation regularizer"
        )
        self.parser.add_argument(
            "--trans_reg_w",
            type=float,
        ...
        self.parser.add_argument(
            "--res_folder", type=str, required=True, help="output path for the image"
        )
...
class ImageFittingOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument(
            "--img_path", type=str, required=True, help="path for the image"
        )
...
class VideoFittingOptions(BaseOptions):
    def initialize(self):
        BaseOptions.initialize(self)
        self.parser.add_argument(
            "--v_path", type=str, required=True, help="path for the video"
        )
        self.parser.add_argument("--ngpus", type=int, default=1, help="gpu device")
        self.parser.add_argument(
            "--nworkers", type=int, default=1, help="number of workers"
        )
